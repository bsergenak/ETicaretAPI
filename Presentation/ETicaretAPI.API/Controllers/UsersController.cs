...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Get All User", Menu = "Users")]
        public async Task<IActionResult> GetAllUser([FromQuery] GetAllUsersQueryRequest getAllUsersQueryRequest)
        {
        ...
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Assign Role To Users", Menu = "Users")]
